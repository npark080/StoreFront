...
namespace StoreFront.UI.MVC.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(StardewContext context)
        {
            _context = context;
        }
        ...
        {
            var stardewContext = _context.Orders.Include(o => o.OrderDetails).Include(o => o.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StardewContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
