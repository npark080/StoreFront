...
namespace StoreFront.UI.MVC.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(StardewContext context)
        {
            _context = context;
        }
        ...
        {
            var stardewContext = _context.OrderDetails.Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StardewContext.OrderDetails'  is null.");
            }
            var orderDetail = await _context.OrderDetails.FindAsync(id);
            if (orderDetail != null)
            {
